...
namespace HonorSDK {
    ...
    /// 类说明：游戏调用IOS的接口
    /// </summary>
    class CustomIosSdkImpl : HonorSDKImpl {
#if IosSDK
        public CustomIosSdkImpl() {
        ...
        public override void GetHardwareInfo(OnFinish<HardwareInfo> getHardwareInfoListener) {
            base.GetHardwareInfo(getHardwareInfoListener);
        }
