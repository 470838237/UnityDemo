...
namespace Honor
{
    ...
    public class BindState
    {
        ...
        public const string PLATFORM_GOOGLE = "google";
        public const string PLATFORM_FACEBOOK = "facebook";
        public const string PLATFORM_TWITTER = "twitter";
    }
    ...
    public class SDKManager
    {
        ...
        public virtual void Login(OnFinish<UserInfo> loginListener, string channel = "", Dictionary<string, string> extra = null)
        {
        ...
        public virtual void Logout(OnFinish<Result> logoutListener, Dictionary<string,string> extra = null)
        {
