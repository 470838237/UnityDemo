...
public class GoodsList : Result
    ...
    public class ResultObbDownload {
        ...
        public const string state_paused_wifi_unavailable = "STATE_PAUSED_NEED_CELLULAR_PERMISSION";
    ...
    class HonorSDK
    {
        ...
        public virtual void GameStepInfo(string type)
        {
        ...
        public virtual void SetClipoboard(string content)
        {
