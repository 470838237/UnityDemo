...
namespace honorsdk
{
    class AndroidSDKImpl : HonorSDK
    {
        ...
        public override void GameStepInfo(string type)
        {
            base.GameStepInfo(type);
            currentActivity.Call("gameStepInfo", type);
        }
        ...
        public override void GetCountryCode(OnFinish<string> getCountryCodeListener)
        {
            ...
            currentActivity.Call("getISOCountryCode");
        }

        public override void ReportError(string errorMsg)
        {
            base.ReportError(errorMsg);
            currentActivity.Call("reportError", errorMsg);
        }
        ...
        public override void SetClipoboard(string content)
        {
            base.SetClipoboard(content);
            currentActivity.Call("setClipoboard");
        }
        public override bool IsSupportApi(Api api)
        {
           base.IsSupportApi(api);
           return  currentActivity.Call<bool>("isSupportApi",api.ToString());
        }
    }
}
