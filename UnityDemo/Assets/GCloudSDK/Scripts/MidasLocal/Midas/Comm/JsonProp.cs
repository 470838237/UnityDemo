...
namespace MidasPay
{
	...
	public class JsonSerializable {
		...
		public JsonSerializable(string json): this(MidasPay.Json.Deserialize (json)){}
		...
		{
			return MidasPay.Json.Serialize (UnityJsonDict);
		}

		public string ToUnityString()
		{
			return MidasPay.Json.Serialize(JsonDict);
		}
	}
