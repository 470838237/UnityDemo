...
namespace MidasPay
{
	...
	///
	///</remarks>
	public class APMidasMonthRequest : APMidasBaseRequest
	{
		///<summary>
		...
		/// note:For iOS, it's not allowed to buy a month service, if you wan to use this for subscribe, please contact with midas
		/// [optional]
		///</summary>
		[JsonProp("autoPay")]
